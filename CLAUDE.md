...
- 分頁導覽：column、rebar、rcbeam、rccolumn、unit
- 頁首設有全域單位系統選擇器
...
- 雙筋梁：Mn1（單筋最大）+ Mn2 補足，壓力鋼筋降伏檢核
- 所有輸出依全域單位系統轉換（resultInSystem）

### RC 柱斷面設計
- **斷面幾何**：預設形狀（矩形/圓形/T型/L型）含參數化輸入，或自訂頂點
- **空心區域**：無空心/空心矩形/空心圓形/自訂頂點
- **斷面預覽**：SVG 即時渲染，顯示外輪廓、空心、鋼筋（圓點按實際面積繪製）、塑性中心標記、方位角箭頭
...
- `e90bc24` 更新 CLAUDE.md 提交歷史
- `2ea2ea4` 修正 P-M 交互圖：每筆載重獨立 α 角與 3D 曲面內插檢核
